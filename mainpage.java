	...
	public mainpage() {
		...
		i8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\instructions.jpg"));
		...
		i0.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JLabel lblNewLabel_1 = new JLabel("");
				f.getContentPane().add(lblNewLabel_1);
				lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\pi.png"));
		...
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\cbse.png"));
		lblNewLabel.setBounds(277, 80, 1076, 205);
		F.add(lblNewLabel);
		
		JButton btnNewButton = new JButton("Home");
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\home.png"));
	    ...
	    lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\sb.png"));
		lblNewLabel_1.setBounds(1025, 17, 142, 78);
		F.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\cbse logo 2.png"));
		lblNewLabel_2.setBounds(1426, 10, 104, 95);
		F.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\75.png"));
		lblNewLabel_3.setBounds(1214, 3, 159, 107);
		F.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\mainpage1.png"));
		lblNewLabel_4.setBounds(220, 307, 320, 231);
		F.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\mainpage2.png"));
		lblNewLabel_5.setBounds(609, 307, 365, 231);
		F.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\gayat\\Downloads\\mainpage3.png"));
